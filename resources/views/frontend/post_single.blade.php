                ...
                <div class="post post-single">
                    ...
                    <div class="post-header">
                        ...
                        <ul class="meta list-inline mb-0">
                            <li class="list-inline-item"><a href="blog-single.html#"><img src="images/other/author-sm.png" class="author" alt="author"/>Katen Doe</a></li>
                    ...
                    <div class="featured-image">
                        <img src="{{ asset('storage/posts/'.$post->featured_image) }}" alt="post-title" style="width: 100%"/>
                    </div>
                    <!-- post content -->

...
<div class="col-sm-6">
    ...
    <div class="post post-grid rounded bordered h-100">
        <div class="thumb top-rounded">
            <a href="category.html" class="category-badge position-absolute">{{ $post->category->name }}</a>
        ...
        <div class="details">
            <ul class="meta list-inline mb-0">
                <li class="list-inline-item"><a href="classic.html#"><img src="{{ asset('storage/users/'.$post->user->profile) }}" class="author img-fluid rounded-circle" style="width: 50px; height:50px;object-fit:cover; object-position: center;"/>{{ $post->user->name }}</a></li>
                ...
                <div class="sidebar">
                    ...
                    <div class="widget rounded">
                        <div class="widget-about data-bg-image text-center" data-bg-image="images/map-bg.png">
                            ...
                            <ul class="social-icons list-unstyled list-inline mb-0">
                                ...
                                <li class="list-inline-item"><a href="category.html#"><i class="fab fa-pinterest"></i></a></li>
                                <li class="list-inline-item"><a href="category.html#"><i class="fab fa-medium"></i></a></li>
                                <li class="list-inline-item"><a href="category.html#"><i class="fab fa-youtube"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="widget rounded">
                        ...
                        <div class="widget-content">
                            ...
                            <span class="newsletter-privacy text-center mt-3">By signing up, you agree to our <a href="category.html#">Privacy Policy</a></span>
                        </div>
                    </div>
